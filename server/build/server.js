...
const converte_minutes_to_string_hours_1 = require("./utils/converte-minutes-to-string-hours");
...
app.get('/games/:id/ads', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.json(ads.map((ad) => {
        return Object.assign(Object.assign({}, ad), { weekDays: ad.weekDays.split(','), hourStart: (0, converte_minutes_to_string_hours_1.convertMinutesToStringHours)(ad.hourStart), hourEnd: (0, converte_minutes_to_string_hours_1.convertMinutesToStringHours)(ad.hourEnd) });
    }));
}));
